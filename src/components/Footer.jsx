...
const Footer = () => {
    ...
    return (
        <div>
            <div className="container col-xxl-8 px-4 mt-2">
                <hr />
                <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4">
                    <p className="col-md-4 mb-0 text-body-secondary">&copy; {date} Santiago Cabrerizo</p>


                    <button onClick={scrollToTop} className="boton-footer col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto">
                    ...
                    <ul className="nav col-md-4 justify-content-end">
                        ...
                        <li className="nav-item">
                            <a href="https://github.com/SantiagoCabrerizo" target='_blank' className="nav-link px-2 link-body-emphasis">
                        ...
                        <li className="nav-item">
                            <a href="https://www.linkedin.com/in/santiago-cabrerizo-0a6097240/" target='_blank' className="nav-link px-2 link-body-emphasis">
                        ...
                        <li className="nav-item">
                            <a href="https://www.instagram.com/santi.cabrerizo/" target='_blank' className="nav-link px-2 link-body-emphasis">
