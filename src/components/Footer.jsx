    ...
    return (
        <div className='backg'>
            <div className='container col-xxl-8 p-4'>
                    ...
                    <div className='col'>
                        <ul className="nav justify-content-end">
                            <li className="nav-item">
                                <a href="https://github.com/SantiagoCabrerizo" target='_blank' rel='noreferrer' className="nav-link px-2 link-body-emphasis">
                            ...
                            <li className="nav-item">
                                <a href="https://www.linkedin.com/in/santiago-cabrerizo-0a6097240/" target='_blank' rel='noreferrer' className="nav-link px-2 link-body-emphasis">
                            ...
                            <li className="nav-item">
                                <a href="https://www.instagram.com/santi.cabrerizo/" target='_blank' rel='noreferrer' className="nav-link ps-2 link-body-emphasis">
                ...
                <div className='row'>
                    <Scroll to='header' className='col d-flex justify-content-center align-items-center' >
